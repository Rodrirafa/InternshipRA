...
View.OnTouchListener{
    ...
    private void initVideos() {
        ...
        //remoteVideoView.setScaleX(1.1f);
        //remoteVideoView.setScaleY(0.95f);
    ...
    public void start() {
        ...
        if (videoCapturerAndroid != null) {
           // videoCapturerAndroid.startCapture(1024, 1920,30);
        }
    ...
    private void gotRemoteStream(MediaStream stream) {
        ...
        Log.d("debug","w: " + remoteVideoView.getWidth() + " h: " + remoteVideoView.getHeight());
    ...
    public boolean onTouch(View v, MotionEvent event) {
        if (event.getAction() == MotionEvent.ACTION_DOWN && v.getId() == R.id.remote_gl_surface_view) {
            ...
            SignallingClient.getInstance().touch(str);
            //socket.emit("touch", str);
            //socket.emit("new message", "touch " + x + " : " + y);
            return true;
        }
        Log.d("debug", "v.getid()= " + (v.getId() == R.id.remote_gl_surface_view ) + " action down bool= " +
                (event.getAction() == MotionEvent.ACTION_DOWN) + " action down= " + event.getAction());
        return false;
    }
}
