...
public class PointCloudRenderer {
   ...
   */
  public void update(CustomPointCloud cloud) {
    ...
    numPoints = cloud.getFloatBuffer().remaining() / FLOATS_PER_POINT;
    ...
    GLES20.glBufferSubData(
        GLES20.GL_ARRAY_BUFFER, 0, numPoints * BYTES_PER_POINT, cloud.getFloatBuffer());
    GLES20.glBindBuffer(GLES20.GL_ARRAY_BUFFER, 0);
